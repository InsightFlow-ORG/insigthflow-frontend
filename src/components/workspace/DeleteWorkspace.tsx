...
export default function DeleteWorkspace() {
  ...
  const handleDelete = async () => {
    if (!workspaceId.trim()) {
      setResult({
        success: false,
        message: "Por favor ingresa un ID de workspace válido",
      });
      return;
    }
    ...
    try {
      ...
      const success: boolean = await workspaceApi.deleteWorkspace(workspaceId);

      if (success) {
        setResult({
          success: true,
          message: `El workspace con ID "${workspaceId}" ha sido marcado como eliminado.`,
        });
        ...
        setResult({
          success: false,
          message: "No se pudo eliminar el workspace. ID no encontrado.",
        });
      }
    } catch (error) {
      setResult({
        ...
        <div className="bg-white shadow-lg border border-gray-300 rounded-2xl overflow-hidden">
          ...
          <div className="bg-black p-6 text-white">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-2xl font-bold">Eliminar Workspace</h1>
          ...
          <div className="p-6 space-y-6">
            ...
            <div className="flex gap-3 pt-2">
              <button
                ...
                disabled={!workspaceId.trim() || loading}
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-gray-700 text-xs mt-1">
                Si tienes dudas sobre qué workspace eliminar, ve la sección de ver workspaces.
              </p>
            </div>
          </div>
        </div>
